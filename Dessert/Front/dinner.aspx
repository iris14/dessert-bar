<%@ Page Title="" Language="C#" MasterPageFile="~/Front/Front.Master" AutoEventWireup="true" CodeBehind="dinner.aspx.cs" Inherits="Dessert.Front.dinner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div class="breakfast">
            ...
            <p>
                <asp:Label ID="Label1" runat="server" Text="晚餐" Font-Size="XX-Large" ForeColor="#33CC33"></asp:Label>
            </p>
            <div style="border-style: double">
                <div align="center">
                    <p>
                    <asp:Label ID="Label2" runat="server" Text="☀无糖" Font-Size="X-Large" ForeColor="#99CCFF"></asp:Label>
                </p>
                </div>
                <div>
            ...
            <div>
                <div align="center">
                    <p>
                    <asp:Label ID="Label3" runat="server" Text="☀无油" Font-Size="X-Large" ForeColor="#99CCFF"></asp:Label>
                </p>
                </div>
                <div>
            ...
            <div>
                <div align="center">
                    <p>
                    <asp:Label ID="Label4" runat="server" Text="☀低脂" Font-Size="X-Large" ForeColor="#99CCFF"></asp:Label>
                </p>
                </div>
                <div>
            ...
            <div>
                <div align="center">
                    <p>
                    <asp:Label ID="Label5" runat="server" Text="☀低卡" Font-Size="X-Large" ForeColor="#99CCFF"></asp:Label>
                </p>
                </div>
                <div>
            ...
            <div>
                <div align="center">
                    <p>
                    <asp:Label ID="Label6" runat="server" Text="☀低糖" Font-Size="X-Large" ForeColor="#99CCFF"></asp:Label>
                </p>
                </div>
                <div>
