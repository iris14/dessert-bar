<%@ Page Title="" Language="C#" MasterPageFile="~/Front/Front.Master" AutoEventWireup="true" CodeBehind="lunch.aspx.cs" Inherits="Dessert.Front.lunch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div>
        <div class="breakfast">
            ...
            <p>
                <asp:Label ID="Label1" runat="server" Text="午餐" Font-Size="XX-Large" ForeColor="#33CC33"></asp:Label>
            </p>
            ...
            <div>
                <div align="center">
                    <p>
                    <asp:Label ID="Label4" runat="server" Text="☀健康" Font-Size="X-Large" ForeColor="#99CCFF"></asp:Label>
                </p>
                </div>
                <div>
            ...
            <div>
                <div align="center">
                    <p>
                    <asp:Label ID="Label5" runat="server" Text="☀养生" Font-Size="X-Large" ForeColor="#99CCFF"></asp:Label>
                </p>
                </div>
                <div>
